//! local_context_detection — extracted from mod.rs.
...
use crate::core::context::ContainedComponentInfo;
use crate::core::context::ComponentGap;
use crate::core::context::ContextOutput;
...
pub(crate) fn detect_git_root(cwd: &PathBuf) -> Option<String> {
...
pub(crate) fn path_matches(cwd: &Path, local_path: &str) -> bool {
...
pub(crate) fn find_project_for_components(component_ids: &[String]) -> Option<project::Project> {
