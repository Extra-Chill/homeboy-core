...
mod tests {
    ...
    fn test_get_latest_finalized_version_trimmed_starts_with() {
        ...
        assert!(
            result.is_some(),
            "expected Some for: trimmed.starts_with(\"## \")"
        );
    }
    ...
    fn test_get_latest_finalized_version_let_some_version_extract_version_from_heading_label() {
        ...
        assert!(
            result.is_some(),
            "expected Some for: let Some(version) = extract_version_from_heading(label)"
        );
    }
    ...
    fn test_get_latest_finalized_version_let_some_version_extract_version_from_heading_label_2() {
        ...
        assert!(
            result.is_none(),
            "expected None for: let Some(version) = extract_version_from_heading(label)"
        );
    }
    ...
    fn test_extract_first_bullet_let_some_rest_trimmed_strip_prefix() {
        ...
        assert!(
            result.is_some(),
            "expected Some for: let Some(rest) = trimmed.strip_prefix(\"- \")"
        );
    }
    ...
    fn test_extract_first_bullet_let_some_rest_trimmed_strip_prefix_4() {
        ...
        assert!(
            result.is_none(),
            "expected None for: let Some(rest) = trimmed.strip_prefix(\"* \")"
        );
    }
