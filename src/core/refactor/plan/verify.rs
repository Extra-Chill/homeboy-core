...
mod tests {
    ...
    fn test_run_audit_refactor_default_path() {
        ...
        let write = false;
        let _result = run_audit_refactor(initial_result, &only_kinds, &exclude_kinds, scoring, _max_iterations, write);
    }
    ...
    fn test_run_audit_refactor_has_expected_effects() {
        ...
        let _max_iterations = 0;
        let write = false;
        let _ = run_audit_refactor(initial_result, &only_kinds, &exclude_kinds, scoring, _max_iterations, write);
    }
